...
/* ---------------------------------------------------------
 Q2. Customers who used a discount AND spent above avg spend
----------------------------------------------------------*/
SELECT 
    customer_id, 
    purchase_amount
...
/* ---------------------------------------------------------
 Q4. Compare avg purchase amount between shipping types
----------------------------------------------------------*/
SELECT 
    shipping_type,
...
/* ---------------------------------------------------------
 Q5. Do subscribed customers spend more?
     Compare avg spend & total revenue
----------------------------------------------------------*/
SELECT 
    subscription_status,
...
/* ---------------------------------------------------------
 Q9. Are repeat buyers (previous_purchases >5) subscribed?
----------------------------------------------------------*/
SELECT 
    subscription_status,
